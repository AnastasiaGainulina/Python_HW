...
from Seminar_13.task_03 import AccesErorr, LevelError
...
class UserWorkshop:
    ...
    def login(self, name: str, id: str) -> str:                 #авторизация пользователя, если есть такой то возвращает уровень пользователя
        ...
        for user in UserWorkshop.user_list:
            ...
            raise AccesErorr(name)                  # возбуждение ошибки прописанной в модуле task_03.py
...
b = UserWorkshop()
print(b.login('Smirnov', '1')) #(имя, id)  уровень = 5
